#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2023/10/23 15:59
# @Author  : zhangqi
# @File    : ec_model_without_schedule.py
# @Software: PyCharm
...
from core.decision_module.expression import upload_time, received_task, queue_after_process, \
    time_of_deploy, cost_of_deploy, time_of_process, \
    c1, c9, c10, c71, c72, obj_rule


def queue_before_process(model, j, a):
    return model.queue_[j, a] + model.received_task[j, a]
